...
/** @brief IMU B2S inputs parameters definition
 *  @note Refer to the datasheet for details on how to configure these parameters.
 */
typedef struct {
...
/** @brief APEX VVD inputs parameters definition
 *  @note Refer to the datasheet for details on how to configure these parameters.
 */
typedef struct {
 ...
 *  @warning It is up to application level to save/restore previously configured APEX parameters, if any,
 *           with `inv_imu_edmp_set_tap_parameters`, `inv_imu_edmp_set_ff_parameters`, `inv_imu_edmp_set_b2s_parameters`,
 *           `inv_imu_edmp_set_aid_parameters`, `inv_imu_edmp_set_gaf_parameters` or `inv_imu_edmp_set_vvd_parameters`.
...
/** @brief Returns current EDMP parameters for AID APEX algorithm.
 *  @param[in] s   Pointer to device.
 *  @param[out] p  The current parameters read from registers.
 *  @return        0 on success, negative value on error.
 */
...
/** @brief Returns current EDMP parameters for B2S APEX algorithm.
 *  @param[in] s   Pointer to device.
 *  @param[out] p  The current parameters read from registers.
 *  @return        0 on success, negative value on error.
 */
...
/** @brief Configures EDMP parameters for AID APEX algorithm.
 *  @warning This function should be called only when AID algorithm is disabled.
 *  @param[in] s  Pointer to device.
 *  @param[in] p  The requested input parameters.
 *  @return       0 on success, negative value on error.
 */
...
/** @brief Configures EDMP parameters for B2S APEX algorithm.
 *  @warning This function should be called only when B2S algorithm is disabled.
 *  @param[in] s  Pointer to device.
 *  @param[in] p  The requested input parameters.
 *  @return       0 on success, negative value on error.
 */
...
/** @brief  Run on-demand service to request APEX SIF set PDR on-demand feature.
 *  @param[in]  s                Pointer to device.
...
/** @brief  Set current APEX VVD machine learning model.
 *  @param[in] s                           Pointer to device.
 *  @return                                0 on success, negative value on error.
 */
int inv_imu_edmp_set_vvd_model(inv_imu_device_t *s);

/** @brief  Get current APEX VVD configuration settings.
 *  @param[in]  s           Pointer to device.
...
/** @brief  Set current APEX VVD configuration settings.
 *  @param[in]  s           Pointer to device.
...
/** @brief  Enable APEX algorithm Activity/Inactivity Detection.
 *  @param[in] s  Pointer to device.
 *  @return       0 on success
...
/** @brief  Disable APEX algorithm Activity/Inactivity Detection.
 *  @param[in] s  Pointer to device.
 *  @return       0 on success, negative value on error.
 */
...
/** @brief  Retrieve the current output state of the APEX AID human instance
 *  @param[in] s              Pointer to device.
...
/** @brief  Retrieve the current output state of the APEX AID device instance
 *  @param[in] s              Pointer to device.
...
/** @brief  Build APEX GAF output value based on FIFO frame. 
 *  @param[in]  s    Pointer to device.
...
/** @brief Request dynamic environment threshold parameter update of APEX VVD without re-init.
 *  @param[in]  s                   Pointer to device.
...
/** @brief Verify APEX VVD dynamic environment threshold parameter update status.
 *  @param[in]  s                   Pointer to device.
