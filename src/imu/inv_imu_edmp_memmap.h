 ...
 *
 * Externally computed accelerometer biases to start algorithm with (one value per axis).
 * Unit: gee in s32q16
 * Default: 0;0;0
 */
 ...
 *
 * Externally computed accelerometer accuracy from 0 (non calibrated) to 3 (well calibrated) to start algorithm with.
 * Range : [0 - 3]
 * Default: 0
 */
 ...
 * Default: 0;0;0
 */
#define EDMP_GAF_GYR_BIAS_DPS_Q12                               0x5cc
 ...
 * Default: 0
 */
#define EDMP_GAF_READ_GYR_ACCURACY                              0x5e4
 ...
 *
 * Temperature to start algorithm with, also acts as latest temperature associated with computed gyro bias to be saved.
 * Unit: degree C in s32q16
 * Default: 0
 */
#define EDMP_GAF_GYR_BIAS_TEMPERATURE_DEG_Q16                   0x5a0
 ...
 *
 * Lower bound limit of the last sample's norm considered for b2s detection, in s32q24. Value corresponding to the squared norm value of 0.687g^2 is: 11532816
 * Unit: s32q24
 */
 ...
 *
 * Higher bound limit of the last sample's norm considered for b2s detection, in s32q24. Value corresponding to the squared norm value of 1.371g^2 is: 23001616
 * Unit: s32q24
 */
